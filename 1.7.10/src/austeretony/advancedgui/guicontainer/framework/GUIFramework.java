...
public class GUIFramework {
	 ...
	 */
	public GUIFramework(GUIPosition slotsPosition, IInventory inventory, int firstSlotIndex, int lastSlotIndex, int rows, int columns) {
	...
	public int getSlotWidth() {
		...
		return this.slotRenderer != null ? this.slotRenderer.slotWidth : 16;
	}
	
	public int getSlotHeight() {
		
		return this.slotRenderer != null ? this.slotRenderer.slotHeight : 16;
	}
