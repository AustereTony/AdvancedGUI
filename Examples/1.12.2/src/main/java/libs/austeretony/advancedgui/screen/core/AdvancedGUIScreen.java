...
/**
 * Модернизированный GuiScreen. Должен быть унаследован вашим ГПИ.
 * Тут ещё ОЧЕНЬ много работы.
 */
...
public abstract class AdvancedGUIScreen extends GuiScreen {
    ...
    /** Массив объектов GUIFramework */
	protected final List<GUIFramework> frameworks = new ArrayList<GUIFramework>();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		for (GUIFramework framework : this.frameworks) {
	        ...
	        for (GUIButtonPanel buttonPanel : framework.getButtonPanelsList()) {
	            ...
	            buttonPanel.mouseOver(mouseX, mouseY);
	            
	            buttonPanel.draw();	  
	            
	            buttonPanel.drawPopup(mouseX, mouseY);
	        }
		}
    ...
    protected void renderToolTip(ItemStack itemStack, int x, int y) {
        ...
        this.drawHoveringText(this.getItemToolTip(itemStack), x, y, (font == null ? fontRenderer : font));
            ...
            if (hoverevent.getAction() == HoverEvent.Action.SHOW_ITEM) {
                ...
                if (this.mc.gameSettings.advancedItemTooltips) {
                    ...
                    try {
                        ...
                        list.add(tagCompound.getString("name"));

                        if (tagCompound.hasKey("type", 8)) {
                        	
                            String s = tagCompound.getString("type");
                            list.add("Type: " + s);
                        }

                        list.add(tagCompound.getString("id"));
