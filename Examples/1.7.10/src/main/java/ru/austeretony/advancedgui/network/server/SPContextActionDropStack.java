		...
		switch (this.inventoryId) {
			...
			case 0:
				...
				if (player.openContainer instanceof ContainerInventory) {
					...
					player.entityDropItem(((ContainerAdvancedStorage) player.openContainer).playerInventory.getStackInSlot(this.slotIndex), 1.0F).delayBeforeCanPickup = 40;
				}
			...
			case 1:
				...
				player.entityDropItem(((ContainerAdvancedStorage) player.openContainer).slorageInventory.getStackInSlot(this.slotIndex), 1.0F).delayBeforeCanPickup = 40;
