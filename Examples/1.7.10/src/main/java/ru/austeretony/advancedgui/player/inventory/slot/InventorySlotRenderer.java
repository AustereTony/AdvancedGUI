...
public class InventorySlotRenderer extends GUISlotRenderer {
	...
	public void drawSlotHighlighting(Slot slot) {
		...
		this.drawGradientRect(slot.xDisplayPosition, slot.yDisplayPosition, slot.xDisplayPosition + this.getWidth(), slot.yDisplayPosition + this.getHeight(), - 2130706433, - 2130706433, 300.0);
