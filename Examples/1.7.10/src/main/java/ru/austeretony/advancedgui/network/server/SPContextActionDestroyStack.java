		...
		switch (this.inventoryId) {
			...
			case 0:
				...
				if (player.openContainer instanceof ContainerInventory) {
					...
					((ContainerAdvancedStorage) player.openContainer).playerInventory.setInventorySlotContents(this.slotIndex, null);			
				}
			...
			case 1:
				...
				((ContainerAdvancedStorage) player.openContainer).slorageInventory.setInventorySlotContents(this.slotIndex, null);
