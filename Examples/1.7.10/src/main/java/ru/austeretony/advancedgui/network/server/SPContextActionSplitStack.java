		...
		switch (this.inventoryId) {
			...
			case 0:
				...
				if (player.openContainer instanceof ContainerExtendedInventory) {
					...
					itemStack = ((ContainerExtendedInventory) player.openContainer).inventory.getStackInSlot(this.slotIndex).copy();
				
					((ContainerExtendedInventory) player.openContainer).inventory.decrStackSize(this.slotIndex, itemStack.stackSize / 2);	
				
					itemStack.stackSize = itemStack.stackSize / 2;
				
					((ContainerExtendedInventory) player.openContainer).inventory.setInventorySlotContents(((ContainerExtendedInventory) player.openContainer).inventory.getFirstEmptyStack(), itemStack);				
				}
					...
					((ContainerStorage) player.openContainer).playerInventory.decrStackSize(this.slotIndex, itemStack.stackSize / 2);	
			...
			case 1:
				...
				((ContainerStorage) player.openContainer).slorageInventory.decrStackSize(this.slotIndex, itemStack.stackSize / 2);	
