...
public class GUIInventory extends AdvancedGUIContainer<GUIInventory> {
	...
	public static final ResourceLocation TEXTURE_INVENTORY = new ResourceLocation(AdvancedGUIMain.MODID, "textures/gui/inventory/inventoryFirst.png");
    ...
    private void initInventory() {
    	...
    	this.sortersPanel.addButton(this.baseSorter.setSound(new GUISound(AdvancedGUIMain.MODID + ":" + "click", 1.0F, 1.0F)).enableTexture().setTexture(new ResourceLocation(AdvancedGUIMain.MODID, "textures/gui/inventory/buttons/main.png"), 15, 15).setPopupText(I18n.format("guiButton.mainSection")));
	...
	protected void drawGuiContainerBackgroundLayer(float renderPartialTicks, int mouseX, int mouseY) {
		...
		drawPlayerModel(k + 157, l + 138, 30, 0, 0, this.mc.thePlayer);//Отрисовка игрока.
