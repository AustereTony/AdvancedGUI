...
public class SectionStorage extends GUISection {
    ...
    private void initStorage() {
    	...
    	this.storageSortersPanel.addButton(this.storageBaseSorter.setSound(new GUISound(AdvancedGUIMain.MODID + ":" + "click", 1.0F, 1.0F)).setToggledAtStart(true).setTexture(new ResourceLocation(AdvancedGUIMain.MODID, "textures/gui/inventory/buttons/main.png"), 15, 15).setPopupText(I18n.format("guiButton.mainSection")));
    ...
    private void initInventory() {
    	...
    	this.inventorySortersPanel.addButton(this.inventoryBaseSorter.setSound(new GUISound(AdvancedGUIMain.MODID + ":" + "click", 1.0F, 1.0F)).setToggledAtStart(true).setTexture(new ResourceLocation(AdvancedGUIMain.MODID, "textures/gui/inventory/buttons/main.png"), 15, 15).setPopupText(I18n.format("guiButton.mainSection")));
